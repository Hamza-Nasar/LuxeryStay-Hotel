                                ...
                                >
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                                            ...
                                            <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                                <div className="w-4 h-4 bg-blue-100 dark:bg-blue-900/30 rounded flex items-center justify-center">
                                                    <Bath className="w-3 h-3 text-blue-600 dark:text-blue-400" />
                                                </div>
                ...
                <section className="py-20 bg-white dark:bg-gray-900">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto">
                            Our concierge team is available 24/7 to help you find the perfect room
                            for your stay. Contact us for personalized recommendations.
                        </p>
                        <Link href="/contact">
