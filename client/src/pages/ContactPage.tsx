    ...
    const contactInfo = [
        {
            icon: MapPin,
            title: 'Visit Us',
            details: ['123 Luxury Avenue', 'Karachi District', 'Pakistan, NY 75000'],
            color: 'text-blue-600 dark:text-blue-400'
        },
        {
            icon: Phone,
            title: 'Call Us',
            details: ['+92 (308) 897-7132', '+92 (343) 281-7886 (Reservations)'],
            color: 'text-green-600 dark:text-green-400'
        },
        {
            icon: Mail,
            title: 'Email Us',
            details: ['hamzanasar144@gmail.com', 'luxuryhotel.com'],
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
                            ...
                            <div className="mt-4 flex justify-center">
                                <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-2 rounded-lg font-semibold transition-all duration-300">
                                    <a href="https://maps.app.goo.gl/rEXNNQWmifNPqTDi6" target="_blank" rel="noopener noreferrer">View on Google Maps</a>
                                </button>
                            </div>
                        </div>
                    </div>
